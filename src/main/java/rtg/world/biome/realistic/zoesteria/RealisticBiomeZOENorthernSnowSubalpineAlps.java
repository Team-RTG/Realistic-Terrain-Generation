...
public class RealisticBiomeZOENorthernSnowSubalpineAlps extends RealisticBiomeZOEBase {

    public RealisticBiomeZOENorthernSnowSubalpineAlps(Biome biome) {
    ...
    public SurfaceBase initSurface() {
        ...
        return new SurfaceBOPAlpsFoothills(getConfig(), baseBiome().topBlock, //Block top
