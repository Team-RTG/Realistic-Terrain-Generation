...
public class RealisticBiomeBYGSonoranDesert extends RealisticBiomeBYGBase {

    public RealisticBiomeBYGSonoranDesert(Biome biome) {
    ...
    public void initConfig() {
        ...
        this.getConfig().SURFACE_FILLER_BLOCK.set("");
