...
public class SurfaceVanillaStoneBeach extends SurfaceBase {
    ...
    public SurfaceVanillaStoneBeach(RealisticBiomeBase biome, boolean genBeach, float minCliff, float stoneCliff, float stoneHeight, float stoneStrength, float clayCliff) {
    ...
    public SurfaceVanillaStoneBeach(RealisticBiomeBase biome, boolean genBeach, float minCliff) {
        super(biome);
        beach = genBeach;
