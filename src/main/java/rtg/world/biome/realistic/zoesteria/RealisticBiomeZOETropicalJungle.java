...
public class RealisticBiomeZOETropicalJungle extends RealisticBiomeZOEBase {

    public RealisticBiomeZOETropicalJungle(Biome biome) {
        super(biome);
    }
    ...
    public SurfaceBase initSurface() {
        ...
        return new SurfaceVanillaForest(getConfig(), baseBiome().topBlock, baseBiome().fillerBlock, 0f, 1.5f, 60f, 65f, 1.5f,
                BlockUtil.getStateClay(EnumDyeColor.RED), 0.6f,
                BlockUtil.getStateClay(EnumDyeColor.ORANGE), -0.2f,
                BlockUtil.getStateClay(EnumDyeColor.YELLOW), -0.4f
        );
    }
