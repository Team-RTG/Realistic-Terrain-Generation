...
public class SurfaceBOPRainforest extends SurfaceBase {
    ...
    public SurfaceBOPRainforest(RealisticBiomeBase biome, boolean genBeach, IBlockState genBeachBlock, float minCliff, float stoneCliff, float stoneHeight, float stoneStrength, float clayCliff) {
    ...
    public SurfaceBOPRainforest(RealisticBiomeBase biome, boolean genBeach, IBlockState genBeachBlock, float minCliff) {
        super(biome);
        beach = genBeach;
