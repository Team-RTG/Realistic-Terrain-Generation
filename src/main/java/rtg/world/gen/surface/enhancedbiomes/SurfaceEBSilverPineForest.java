...
import rtg.world.biome.realistic.enhancedbiomes.RealisticBiomeEBSilverPineForest;
...
public class SurfaceEBSilverPineForest extends SurfaceEBBase
{
	...
	public SurfaceEBSilverPineForest(Block top, Block fill, boolean genBeach, Block genBeachBlock, float minCliff) 
	{
		super(top, fill);
		beach = genBeach;
	...
	public SurfaceEBSilverPineForest(Block top, Block fill, boolean genBeach, Block genBeachBlock, float minCliff, float stoneCliff, float stoneHeight, float stoneStrength, float snowCliff, float snowHeight, float snowStrength, float clayCliff)
	{
