...
public class RealisticBiomeAddonRedDesertMountains extends RealisticBiomeBase
{
	private TerrainBase terrain;
	private SurfaceBase surface;
	private SurfaceBase riverSurface;

	public RealisticBiomeAddonRedDesertMountains() 
	{
		super(
				RealisticBiomeAddonBase.redDesertMountains,
				BiomeBase.climatizedBiome(BiomeGenBase.river, BiomeBase.Climate.HOT),
				new TerrainHilly(230f, 120f, 0f),
				new SurfaceRedDesert()
				//new SurfaceRiverOasis()
				);
		
		this.setRealisticBiomeName("Red Desert Mountains");
		this.biomeSize = BiomeSize.NORMAL;
		this.biomeWeight = ConfigAddon.weightRedDesertMountains;
	}
