...
import rtg.world.biome.realistic.enhancedbiomes.RealisticBiomeEBMountainsEdge;
...
public class SurfaceEBMountainsEdge extends SurfaceEBBase
{
	...
	public SurfaceEBMountainsEdge(Block top, Block fill, boolean genBeach, Block genBeachBlock, float minCliff) 
	{
		super(top, fill);
		beach = genBeach;
	...
	public SurfaceEBMountainsEdge(Block top, Block fill, boolean genBeach, Block genBeachBlock, float minCliff, float stoneCliff, float stoneHeight, float stoneStrength, float snowCliff, float snowHeight, float snowStrength, float clayCliff)
	{
