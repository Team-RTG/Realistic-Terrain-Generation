...
public class SurfaceVanillaJungleHills extends SurfaceBase {
    ...
    public SurfaceVanillaJungleHills(RealisticBiomeBase biome, boolean genBeach, float minCliff, float stoneCliff,
    ...
    public SurfaceVanillaJungleHills(RealisticBiomeBase biome, boolean genBeach, float minCliff) {
