...
public class RealisticBiomeBOPLushDesert extends RealisticBiomeBOPBase {
    ...
    public RealisticBiomeBOPLushDesert(BiomeConfig config) {
        ...
        decoFallenTree.randomLogBlocks = new IBlockState[]{Blocks.LOG2.getDefaultState().withProperty(BlockNewLog.VARIANT, BlockPlanks.EnumType.DARK_OAK), BlockBOPLog.paging.getVariantState(BOPWoods.EBONY), Blocks.LOG.getDefaultState()};
