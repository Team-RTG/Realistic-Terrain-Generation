...
public class TerrainVanillaSavannaPlateauM extends TerrainBase
{
    ...
    public TerrainVanillaSavannaPlateauM(float mountainWidth, float mountainStrength, float depthLake)
    {
    
        this(mountainWidth, mountainStrength, depthLake, 260f, 68f);
    }
    
    public TerrainVanillaSavannaPlateauM(float mountainWidth, float mountainStrength, float depthLake, float widthLake, float height)
    {
