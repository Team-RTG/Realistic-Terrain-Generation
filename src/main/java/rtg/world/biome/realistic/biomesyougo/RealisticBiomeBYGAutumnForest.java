...
public class RealisticBiomeBYGAutumnForest extends RealisticBiomeBYGBase {
    ...
    private static IBlockState cikaLogBlock    = BlockUtil.getBlockStateFromCfgString("BiomesYouGo:CikaLog", BlockUtil.getStateLog(EnumType.OAK));
    private static IBlockState cikaLeavesBlock = BlockUtil.getBlockStateFromCfgString("BiomesYouGo:CikaLeaves", BlockUtil.getStateLeaf(EnumType.OAK));
    ...
    public class TerrainBYGAutumnForest extends TerrainBase {
        ...
        public float generateNoise(IRTGWorld rtgWorld, int x, int y, float border, float river) {
            ...
            float h = terrainGrasslandHills(x, y, rtgWorld.simplex(), river, peakyHillWavelength, peakyHillStrength, smoothHillWavelength, smoothHillStrength, baseHeight);
    ...
    public void initDecos() {
        ...
        quercusRoburOakTree.getValidGroundBlocks().add(BlockUtil.getStateDirt(DirtType.PODZOL));
