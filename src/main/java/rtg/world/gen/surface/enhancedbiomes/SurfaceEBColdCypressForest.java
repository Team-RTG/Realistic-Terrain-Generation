...
import rtg.world.biome.realistic.enhancedbiomes.RealisticBiomeEBColdCypressForest;
...
public class SurfaceEBColdCypressForest extends SurfaceEBBase
{
	...
	public SurfaceEBColdCypressForest(Block top, Block fill, boolean genBeach, Block genBeachBlock, float minCliff) 
	{
		super(top, fill);
		beach = genBeach;
	...
	public SurfaceEBColdCypressForest(Block top, Block fill, boolean genBeach, Block genBeachBlock, float minCliff, float stoneCliff, float stoneHeight, float stoneStrength, float snowCliff, float snowHeight, float snowStrength, float clayCliff)
	{
