...
//import rtg.blocks.EnhancedBiomesBlocks;
//import rtg.event.TreeGen;
import rtg.village.StructureVillagePiecesRTG;
import rtg.village.StructureVillagePiecesRTG.Start;
import rtg.village.StructureVillagePiecesRTG.Village;
//import rtg.world.gen.WorldGenShrineTree;
...
public class Torii extends StructureVillagePiecesRTG.Village
{
	public Torii() {
	}

	public Torii(StructureVillagePiecesRTG.Start p_i2101_1_, int p_i2101_2_, Random p_i2101_3_, StructureBoundingBox p_i2101_4_, int p_i2101_5_) {
		super(p_i2101_1_, p_i2101_2_);
		this.coordBaseMode = p_i2101_5_;
		this.boundingBox = p_i2101_4_;
	}

	public static Torii getPiece(StructureVillagePiecesRTG.Start p_74908_0_, List p_74908_1_, Random p_74908_2_, int p_74908_3_, int p_74908_4_, int p_74908_5_, int p_74908_6_, int p_74908_7_) {
	...
	public boolean addComponentParts(World world, Random rand, StructureBoundingBox p_74875_3_) {
...

		{
			...
			this.placeBlockAtCurrentPosition(world, Blocks.lit_redstone_lamp, 0, a, c + 1, b, p_74875_3_);
