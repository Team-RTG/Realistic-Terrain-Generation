...
public class RealisticBiomePVJSnowyBorealForest extends RealisticBiomePVJBase {

    public RealisticBiomePVJSnowyBorealForest(Biome biome) {

        super(biome, RiverType.FROZEN, BeachType.STONE);
    }
    ...
    public SurfaceBase initSurface() {
        ...
        return new SurfaceBYGBiome(
                ...
                baseBiome().topBlock, 0.6f, // Mix block 1
                baseBiome().topBlock, -0.4f // Mix block 2
        );
    }
