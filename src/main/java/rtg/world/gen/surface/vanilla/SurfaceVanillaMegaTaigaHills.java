...
public class SurfaceVanillaMegaTaigaHills extends SurfaceBase {
    ...
    public SurfaceVanillaMegaTaigaHills(RealisticBiomeBase biome, boolean genBeach, IBlockState genBeachBlock, float minCliff, float stoneCliff,
    ...
    public SurfaceVanillaMegaTaigaHills(RealisticBiomeBase biome, boolean genBeach, IBlockState genBeachBlock, float minCliff) {
