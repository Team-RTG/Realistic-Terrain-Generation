...
public class TerrainATGSnowyGravelBeach extends TerrainBase
{
	...
	public TerrainATGSnowyGravelBeach(float mountainWidth, float mountainStrength, float depthLake)
	{
		this(mountainWidth, mountainStrength, depthLake, 260f, 68f);
	}
	
	public TerrainATGSnowyGravelBeach(float mountainWidth, float mountainStrength, float depthLake, float widthLake, float height)
	{
		width = mountainWidth;
