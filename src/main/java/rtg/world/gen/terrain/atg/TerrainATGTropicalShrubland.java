...
public class TerrainATGTropicalShrubland extends TerrainBase
{
	...
	public TerrainATGTropicalShrubland(float mountainWidth, float mountainStrength, float depthLake)
	{
		this(mountainWidth, mountainStrength, depthLake, 260f, 68f);
	}
	
	public TerrainATGTropicalShrubland(float mountainWidth, float mountainStrength, float depthLake, float widthLake, float height)
	{
		width = mountainWidth;
