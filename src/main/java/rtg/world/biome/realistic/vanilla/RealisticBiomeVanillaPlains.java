...
public class RealisticBiomeVanillaPlains extends RealisticBiomeVanillaBase {
    ...
    public void initConfig() {
        ...
        this.getConfig().addProperty(this.getConfig().WHEAT_MIN_Y).set(rtg.api.RTGAPI.config().SEA_LEVEL.get());
    ...
    public class TerrainVanillaPlains extends TerrainBase {
        ...
        public float generateNoise(RTGWorld rtgWorld, int x, int y, float border, float river) {
            ...
            return riverized((rtg.api.RTGAPI.config().SEA_LEVEL.get()) + 2f + groundEffect.added(rtgWorld, x, y), river);
    ...
    public void initDecos() {
        ...
        decoShrubOak.setMaxY((rtg.api.RTGAPI.config().SEA_LEVEL.get()) + 47);
        ...
        decoFlowersRTG.setMaxY((rtg.api.RTGAPI.config().SEA_LEVEL.get()) + 65);
        decoFlowersRTG.setStrengthFactor(2f);
        this.addDeco(decoFlowersRTG);

        // Lots of grass, but not as much as vanilla.
        DecoGrass decoGrass = new DecoGrass();
        decoGrass.setMinY((rtg.api.RTGAPI.config().SEA_LEVEL.get()) + 3);
