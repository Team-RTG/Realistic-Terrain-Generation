...
public class TerrainEBXLRedwoodForest extends TerrainBase
{
	...
	public TerrainEBXLRedwoodForest(float mountainWidth, float mountainStrength, float depthLake)
	{
		this(mountainWidth, mountainStrength, depthLake, 260f, 68f);
	}
	
	public TerrainEBXLRedwoodForest(float mountainWidth, float mountainStrength, float depthLake, float widthLake, float height)
	{
		width = mountainWidth;
