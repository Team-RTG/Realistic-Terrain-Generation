...
public class TerrainVanillaJungleHills extends TerrainBase
{
    ...
    public TerrainVanillaJungleHills(float mountainWidth, float mountainStrength, float depthLake)
    {
    
        this(mountainWidth, mountainStrength, depthLake, 260f, 68f);
    }
    
    public TerrainVanillaJungleHills(float mountainWidth, float mountainStrength, float depthLake, float widthLake, float height)
    {
