...
public class SurfaceACDarklandsForest extends SurfaceACBase {
    ...
    public SurfaceACDarklandsForest(BiomeConfig config, IBlockState top, IBlockState fill, boolean genBeach, IBlockState genBeachBlock, float minCliff, float stoneCliff,
