...
public class RealisticBiomeBOPOriginIsland extends RealisticBiomeBOPBase {
    ...
    public static Biome biome = BOPBiomes.origin_island.orNull();
    ...
    public class TerrainBOPOriginIsland extends TerrainBase {
        ...
        public float generateNoise(IRTGWorld rtgWorld, int x, int y, float border, float river) {
            ...
            return terrainRollingHills(x, y, rtgWorld.simplex(), river, hillStrength, maxHeight, groundNoiseAmplitudeHills, 0f);
        }
    }
    ...
    public SurfaceBase initSurface() {
        ...
        return new SurfaceBOPOriginIsland(config, biome.topBlock, biome.fillerBlock);
    }
