...
public class RealisticBiomeAddonMesaPlains extends RealisticBiomeBase
{
	private SurfaceBase surface;
	
	public RealisticBiomeAddonMesaPlains() 
	{
		super(
		...
		this.setRealisticBiomeName("Mesa Plains");
		this.biomeSize = BiomeSize.NORMAL;
		this.biomeWeight = ConfigAddon.weightMesaPlains;
		this.generateVillages = ConfigAddon.villageMesaPlains;	
	}
