...
public class SurfaceBYGRedDesert extends SurfaceBase {
    ...
    public SurfaceBYGRedDesert(BiomeConfig config, IBlockState top, IBlockState fill, boolean genBeach, IBlockState genBeachBlock, float minCliff, float stoneCliff,
