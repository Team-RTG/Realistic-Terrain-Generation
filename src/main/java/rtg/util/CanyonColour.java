...
public enum CanyonColour {
    ...
    MESA(RTGConfig.getPlateauGradientBlockMetasFromConfigString(RTG.instance.getConfig().MESA_GRADIENT_STRING.get())),
    MESA_BRYCE(RTGConfig.getPlateauGradientBlockMetasFromConfigString(RTG.instance.getConfig().MESA_BRYCE_GRADIENT_STRING.get())),
    SAVANNA(RTGConfig.getPlateauGradientBlockMetasFromConfigString(RTG.instance.getConfig().SAVANNA_GRADIENT_STRING.get()));
    ...
    private static IBlockState plateauBlock = Block.getBlockFromName(RTG.instance.getConfig().PLATEAU_BLOCK_ID.get()).getStateFromMeta(RTG.instance.getConfig().PLATEAU_BLOCK_META.get());
    private static Block plateauGradientBlock = Block.getBlockFromName(RTG.instance.getConfig().PLATEAU_GRADIENT_BLOCK_ID.get());
