...
public class RealisticBiomeBYGJacarandaForest extends RealisticBiomeBYGBase {

    public RealisticBiomeBYGJacarandaForest(Biome biome) {
    ...
    public void initDecos() {
        fallenTrees(new IBlockState[]{
                        BlockUtil.getBlockStateFromCfgString("byg:jacarandalog", BlockUtil.getStateLog(BlockPlanks.EnumType.OAK)),
                        BlockUtil.getBlockStateFromCfgString("byg:jacarandalog", BlockUtil.getStateLog(BlockPlanks.EnumType.OAK))
                },
                new int[]{4, 4}
        );
