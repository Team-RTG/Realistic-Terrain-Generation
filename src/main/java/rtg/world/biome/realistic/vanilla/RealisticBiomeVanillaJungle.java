...
{	
	...
	public RealisticBiomeVanillaJungle()
	{
		super(
			...
			new SurfaceVanillaJungle(Blocks.grass, Blocks.dirt, false, null, 0f, 1.5f, 60f, 65f, 1.5f, Blocks.dirt, (byte)2, 0.15f)
		);
            ...
            for (int b33 = 0; b33 < 5; b33++)
            {
                ...
                if (z52 < 100 && rand.nextBoolean())
                {
                    WorldGenerator worldgenerator =
                        rand.nextInt(5) == 0
                        ? new WorldGenTreeJungleTall(Blocks.log, 3, Blocks.leaves, 3, 12 + rand.nextInt(20), 2 + rand.nextInt(2), 13f, RandomUtil.getRandomInt(rand, 4, 5), 0.32f, 0.1f)
