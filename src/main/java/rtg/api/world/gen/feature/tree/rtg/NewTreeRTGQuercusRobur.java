 ...
 * Attempted revision by Zeno to work with planned forest light control system. Seems too problematic but not yet deleting.
 */
public class NewTreeRTGQuercusRobur extends TreeRTG {

    int heightLimit;
    int height;
    double heightAttenuation = 1.0;//0.618D;
    ...
    public boolean generate(World worldIn, Random rand, BlockPos position) {
        ...
        if (this.heightLimit == 0) {
            this.heightLimit = this.trunkSize + this.crownSize; //5 + this.rand.nextInt(this.heightLimitLimit);
        }
