...
public class RealisticBiomeRWSpruceMountains extends RealisticBiomeRWBase {
    ...
    public TerrainBase initTerrain() {
        ...
        return new TerrainRWSpruceMountains();
    }

    @Override
    public SurfaceBase initSurface() {

        return new SurfaceRWSpruceMountains(getConfig(), biome.topBlock, biome.fillerBlock, 0.45f);
    }
    ...
    public static class TerrainRWSpruceMountains extends TerrainBase {
        ...
        public TerrainRWSpruceMountains() {
    ...
    public static class SurfaceRWSpruceMountains extends SurfaceBase {
        ...
        public SurfaceRWSpruceMountains(BiomeConfig config, IBlockState top, IBlockState fill, float minCliff) {

            super(config, top, fill);
            min = minCliff;
        }

        public SurfaceRWSpruceMountains(BiomeConfig config, IBlockState top, IBlockState fill, float minCliff, float stoneCliff, float stoneHeight, float stoneStrength, float snowCliff, float snowHeight, float snowStrength, float clayCliff) {
