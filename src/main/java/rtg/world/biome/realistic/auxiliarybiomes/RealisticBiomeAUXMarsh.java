...
public class RealisticBiomeAUXMarsh extends RealisticBiomeAUXBase {

    public RealisticBiomeAUXMarsh(Biome biome) {
    ...
    public SurfaceBase initSurface() {
        ...
        return new RealisticBiomeAUXMarsh.SurfaceBOPLushDesert(getConfig(), baseBiome().topBlock, //Block top
