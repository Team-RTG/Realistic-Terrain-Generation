...
public class SurfaceVanillaRedwoodTaigaHillsM extends SurfaceBase
{
    ...
    public SurfaceVanillaRedwoodTaigaHillsM(Block top, Block fill, boolean genBeach, Block genBeachBlock, float minCliff)
    {
    ...
    public SurfaceVanillaRedwoodTaigaHillsM(Block top, Block fill, boolean genBeach, Block genBeachBlock, float minCliff, float stoneCliff,
