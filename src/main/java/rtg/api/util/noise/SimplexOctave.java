...
public class SimplexOctave implements SimplexNoise
{
    ...
    public SimplexOctave(long seed) {
        ...
        for (int i = 0; i < 1024; i++) { source[i] = i; }
    ...
    private static final class LatticePoint2D
    {
        ...
        public int getXsv() { return xsv; }
        public int getYsv() { return ysv; }
    ...
    private static final class Contribution3D
    {
        ...
        private void setNext(Contribution3D next) { this.next = next; }
        private Contribution3D getNext() { return next; }

        private double getDx() { return dx; }
        private double getDy() { return dy; }
        private double getDz() { return dz; }

        private int getXsb() { return xsb; }
        private int getYsb() { return ysb; }
        private int getZsb() { return zsb; }
    }
