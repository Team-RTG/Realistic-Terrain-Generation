...
import rtg.world.biome.realistic.enhancedbiomes.RealisticBiomeEBBorealPlateauM;
...
public class SurfaceEBBorealPlateauM extends SurfaceEBBase
{
	...
	public SurfaceEBBorealPlateauM(Block top, Block filler, Block cliff1, Block cliff2)
	{
		super(top, filler);
