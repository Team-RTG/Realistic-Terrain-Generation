                    ...
                    switch (this.treeType) {
                        ...
                        case HIGHLANDS_SHRUB:
                            ...
                            if (intY <= this.maxY && intY >= this.minY && isValidTreeCondition(noise, rand, strength)) {
                                ...
                                WorldGenerator worldgenerator = new WorldGenHighlandsShrub(this.leavesBlock.getBlock(), this.logBlock.getBlock(), this.leavesBlock.getBlock().getMetaFromState(this.leavesBlock), this.logBlock.getBlock().getMetaFromState(this.logBlock), false);
