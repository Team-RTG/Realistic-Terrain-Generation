...
public class SurfaceBOPLandOfLakes extends SurfaceBase {
    ...
    public SurfaceBOPLandOfLakes(BiomeConfig config, IBlockState top, IBlockState fill, boolean genBeach, IBlockState genBeachBlock, float minCliff, float stoneCliff,
