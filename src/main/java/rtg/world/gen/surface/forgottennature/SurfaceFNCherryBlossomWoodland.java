...
public class SurfaceFNCherryBlossomWoodland extends SurfaceBase {
    ...
    public SurfaceFNCherryBlossomWoodland(BiomeConfig config, IBlockState top, IBlockState fill, boolean genBeach, IBlockState genBeachBlock, float minCliff, float stoneCliff,
