...
import rtg.api.biome.biomesyougo.config.BiomeConfigBYGRedRockMountains;
...
public class RealisticBiomeBYGRedRockMountains extends RealisticBiomeBYGBase {
    ...
    public RealisticBiomeBYGRedRockMountains(Biome biome, BiomeConfig config) {
        ...
        super(config, biome, river,
            new TerrainBYGRedRockMountains(),
            new SurfaceBYGRedRockMountains(config,
        ...
        this.addDeco(decoFallenTree, this.config._boolean(BiomeConfigBYGRedRockMountains.decorationLogsId));
