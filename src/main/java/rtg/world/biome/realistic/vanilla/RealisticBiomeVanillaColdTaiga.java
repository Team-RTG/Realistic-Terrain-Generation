...
public class RealisticBiomeVanillaColdTaiga extends RealisticBiomeVanillaBase
{
    ...
    public void rDecorate(World world, Random rand, int chunkX, int chunkY, OpenSimplexNoise simplex, CellNoise cell, float strength, float river)
    {
        ...
        if (TerrainGen.decorate(world, rand, new BlockPos(chunkX * 16, 0 ,chunkY * 16), SHROOM)) {
        ...
        if (TerrainGen.decorate(world, rand, new BlockPos(chunkX * 16, 0 ,chunkY * 16), PUMPKIN)) {
