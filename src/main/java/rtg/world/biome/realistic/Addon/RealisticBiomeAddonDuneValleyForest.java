...
public class RealisticBiomeAddonDuneValleyForest extends RealisticBiomeBase
{
	private TerrainBase terrain;
	private SurfaceBase surface;

	public RealisticBiomeAddonDuneValleyForest() 
	{
		super(
		...
		this.setRealisticBiomeName("Dune Valley Forest");
		this.biomeSize = BiomeSize.NORMAL;
		this.biomeWeight = ConfigAddon.weightDuneValleyForest;
		this.generateVillages = ConfigAddon.villageDuneValleyForest;
	}
