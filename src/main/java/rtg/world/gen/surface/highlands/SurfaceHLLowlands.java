...
public class SurfaceHLLowlands extends SurfaceHLBase {
    ...
    public SurfaceHLLowlands(BiomeConfig config, IBlockState top, IBlockState fill, boolean genBeach, IBlockState genBeachBlock, float minCliff, float stoneCliff,
        ...
        mixBlock = this.getConfigBlock(config, BiomeConfigHLLowlands.surfaceMixBlockId,
            BiomeConfigHLLowlands.surfaceMixBlockMetaId,
            mix);
        mixHeight = mixSize;
    }
