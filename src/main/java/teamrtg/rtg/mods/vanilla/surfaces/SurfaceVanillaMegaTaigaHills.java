...
public class SurfaceVanillaMegaTaigaHills extends SurfaceBase {
    ...
    public SurfaceVanillaMegaTaigaHills(RealisticBiomeBase biome, boolean genBeach, float minCliff, float stoneCliff,
    ...
    public SurfaceVanillaMegaTaigaHills(RealisticBiomeBase biome, boolean genBeach, float minCliff) {
