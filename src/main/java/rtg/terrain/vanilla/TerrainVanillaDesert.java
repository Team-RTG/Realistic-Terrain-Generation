...
public class TerrainVanillaDesert extends TerrainBase
{
	...
	public TerrainVanillaDesert(float mountainWidth, float mountainStrength, float depthLake)
	{
		this(mountainWidth, mountainStrength, depthLake, 260f, 68f);
	}
	
	public TerrainVanillaDesert(float mountainWidth, float mountainStrength, float depthLake, float widthLake, float height)
	{
		width = mountainWidth;
