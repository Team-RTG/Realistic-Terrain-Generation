...
public class RealisticBiomeBYGRedOutlands extends RealisticBiomeBYGBase {

    public RealisticBiomeBYGRedOutlands(Biome biome) {
    ...
    public TerrainBase initTerrain() {
        ...
        return new TerrainBOPOutback(66f, 50f, 12f);
    }
