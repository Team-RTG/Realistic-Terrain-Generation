...
public class RealisticBiomeAddonCanyonForest extends RealisticBiomeBase
{
	...
	public RealisticBiomeAddonCanyonForest() 
	{
		super(
		...
		this.setRealisticBiomeName("Canyon Forest");
		this.biomeSize = BiomeSize.NORMAL;
		this.biomeWeight = ConfigAddon.weightCanyonForest;
	}
