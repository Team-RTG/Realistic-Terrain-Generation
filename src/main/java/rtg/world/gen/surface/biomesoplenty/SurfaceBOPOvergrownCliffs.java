...
public class SurfaceBOPOvergrownCliffs extends SurfaceBase {
    ...
    public SurfaceBOPOvergrownCliffs(RealisticBiomeBase biome, boolean genBeach, float minCliff, float stoneCliff, float stoneHeight, float stoneStrength, float clayCliff) {
    ...
    public SurfaceBOPOvergrownCliffs(RealisticBiomeBase biome, boolean genBeach, float minCliff) {
        super(biome);
        beach = genBeach;
