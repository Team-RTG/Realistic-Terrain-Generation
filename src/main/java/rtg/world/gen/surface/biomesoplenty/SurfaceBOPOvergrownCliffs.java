...
public class SurfaceBOPOvergrownCliffs extends SurfaceBase {
    ...
    public SurfaceBOPOvergrownCliffs(RealisticBiomeBase biome, boolean genBeach, IBlockState genBeachBlock, float minCliff, float stoneCliff, float stoneHeight, float stoneStrength, float clayCliff) {
    ...
    public SurfaceBOPOvergrownCliffs(RealisticBiomeBase biome, boolean genBeach, IBlockState genBeachBlock, float minCliff) {
        super(biome);
        beach = genBeach;
