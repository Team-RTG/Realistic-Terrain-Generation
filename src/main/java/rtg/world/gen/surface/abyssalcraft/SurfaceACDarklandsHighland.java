...
public class SurfaceACDarklandsHighland extends SurfaceBase {
    ...
    private byte biome.config.MIX_BLOCK.get()TopMeta;
    public IBlockState biome.config.MIX_BLOCK.get()Fill;
    private byte biome.config.MIX_BLOCK.get()FillMeta;
    private float width;
    private float height;
    private float smallW;
    private float smallS;

    public SurfaceACDarklandsHighland(RealisticBiomeBase biome, IBlockState mixTop, IBlockState mixFill, float mixWidth,
