...
public class RealisticBiomeAddonRedOasis extends RealisticBiomeBase
{
	private SurfaceBase surface;
	private SurfaceBase riverSurface;

	public RealisticBiomeAddonRedOasis() 
	{
		super(
				RealisticBiomeAddonBase.redOasis,
				BiomeBase.climatizedBiome(BiomeGenBase.river, BiomeBase.Climate.OASIS),
				new TerrainHilly(180f, 120f, 20f, 60f, 63f),
				new SurfaceDesertOasis(Blocks.grass, Blocks.dirt, Blocks.stained_hardened_clay, Blocks.stained_hardened_clay, (byte)1, 1)
				);
		
		this.setRealisticBiomeName("Red Oasis");
		this.biomeSize = BiomeSize.NORMAL;
		this.biomeWeight = ConfigAddon.weightRedOasis;
		this.generateVillages = ConfigAddon.villageRedOasis;
