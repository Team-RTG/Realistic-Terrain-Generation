...
public class RealisticBiomeIAFGlacier extends RealisticBiomeIAFBase {
    ...
    public SurfaceBase initSurface() {
        ...
        return new SurfaceIAFGlacier(config, this.baseBiome.topBlock, this.baseBiome.fillerBlock, Blocks.SNOW.getDefaultState(), Blocks.SNOW.getDefaultState(), Blocks.PACKED_ICE.getDefaultState(), Blocks.ICE.getDefaultState(), 60f,
            -0.14f, 14f, 0.25f);
    }
