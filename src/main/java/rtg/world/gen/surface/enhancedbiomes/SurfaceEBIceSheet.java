...
import rtg.world.biome.realistic.enhancedbiomes.RealisticBiomeEBIceSheet;
...
{
	public SurfaceEBIceSheet(Block top, Block fill) 
	{
		super(top, fill);
	}
		...
		for(int k = 255; k > -1; k--)
		{
            ...
            else if(b == Blocks.stone)
            {
                ...
                if (shouldReplaceStone()) {
                    blocks[(y * 16 + x) * 256 + k] = RealisticBiomeEBIceSheet.ebDominantStoneBlock[0];
                    metadata[(y * 16 + x) * 256 + k] = RealisticBiomeEBIceSheet.ebDominantStoneMeta[0];
                }
