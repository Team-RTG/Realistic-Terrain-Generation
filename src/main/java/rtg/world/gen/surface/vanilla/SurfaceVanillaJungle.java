...
public class SurfaceVanillaJungle extends SurfaceBase {
    ...
    public SurfaceVanillaJungle(BiomeConfig config, IBlockState top, IBlockState fill, boolean genBeach, IBlockState genBeachBlock, float minCliff, float stoneCliff,
