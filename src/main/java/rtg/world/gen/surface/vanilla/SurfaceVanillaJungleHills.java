...
public class SurfaceVanillaJungleHills extends SurfaceBase {
    ...
    public SurfaceVanillaJungleHills(RealisticBiomeBase biome, boolean genBeach, IBlockState genBeachBlock, float minCliff, float stoneCliff,
    ...
    public SurfaceVanillaJungleHills(RealisticBiomeBase biome, boolean genBeach, IBlockState genBeachBlock, float minCliff) {
