...
public class Hall extends StructureVillagePiecesRTG.Village
{
	public Hall() {
	}

	public Hall(StructureVillagePiecesRTG.Start p_i2099_1_, int p_i2099_2_, Random p_i2099_3_, StructureBoundingBox p_i2099_4_, int p_i2099_5_) {
		super(p_i2099_1_, p_i2099_2_);
		this.coordBaseMode = p_i2099_5_;
		this.boundingBox = p_i2099_4_;
	}

	public static Hall getPiece(StructureVillagePiecesRTG.Start p_74906_0_, List p_74906_1_, Random p_74906_2_, int p_74906_3_, int p_74906_4_, int p_74906_5_, int p_74906_6_, int p_74906_7_) {
