...
public class RealisticBiomeFCPhantasia extends RealisticBiomeFCBase {
    ...
    public SurfaceBase initSurface() {
        ...
        return new SurfaceFCPhantasia(config, this.baseBiome.topBlock, this.baseBiome.fillerBlock);
    }

    public class SurfaceFCPhantasia extends SurfaceBase {

        public SurfaceFCPhantasia(BiomeConfig config, IBlockState top, IBlockState filler) {
