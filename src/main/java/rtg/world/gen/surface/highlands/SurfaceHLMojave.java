...
public class SurfaceHLMojave extends SurfaceHLBase
{

    private byte sandMetadata;
    private int cliffType;

    public SurfaceHLMojave(BiomeConfig config, IBlockState top, IBlockState filler, byte metadata, int cliff)
    {
        ...
        for(int k = 255; k > -1; k--)
        {
            ...
            else if(b == Blocks.stone)
            {
                ...
                else if(depth < 6)
                {
                    ...
                    {
                        primer.setBlockState((y * 16 + x) * 256 + k, Blocks.red_sandstone.getDefaultState());
                    }
                }
            }
        }
