...
public class RealisticBiomeBYGEbonyWoods extends RealisticBiomeBYGBase {

    public RealisticBiomeBYGEbonyWoods(Biome biome) {
    ...
    public void initDecos() {
        fallenTrees(new IBlockState[]{
                        BlockUtil.getBlockStateFromCfgString("byg:ebonylog", BlockUtil.getStateLog(BlockPlanks.EnumType.SPRUCE)),
                        BlockUtil.getBlockStateFromCfgString("byg:ebonylog", BlockUtil.getStateLog(BlockPlanks.EnumType.SPRUCE))
                },
                new int[]{4, 4}
        );
