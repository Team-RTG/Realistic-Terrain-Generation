...
public class RealisticBiomeFLORITulipLand extends RealisticBiomeFLORIBase {
    ...
    RealisticBiomeFLORITulipLand(Biome biome) { super(biome, river); }

    @Override public void initConfig() {}

    @Override public TerrainBase initTerrain() { return new TerrainFLORITulipLand(); }

    public static final class TerrainFLORITulipLand extends TerrainBase {

        private GroundEffect groundEffect = new GroundEffect(6f);

        private TerrainFLORITulipLand() { }
    ...
    @Override public SurfaceBase initSurface() { return new SurfaceFLORITulipLand(config, this.baseBiome.topBlock, this.baseBiome.fillerBlock); }

    public static final class SurfaceFLORITulipLand extends SurfaceBase {

        private SurfaceFLORITulipLand(BiomeConfig config, IBlockState top, IBlockState filler) { super(config, top, filler); }
