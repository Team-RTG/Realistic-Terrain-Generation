...
public class RealisticBiomePVJWillowSwamp extends RealisticBiomePVJBase {

    public RealisticBiomePVJWillowSwamp(Biome biome) {
    ...
    public SurfaceBase initSurface() {
        ...
        return new RealisticBiomePVJWillowSwamp.SurfaceBOPLushDesert(getConfig(), baseBiome().topBlock, //Block top
