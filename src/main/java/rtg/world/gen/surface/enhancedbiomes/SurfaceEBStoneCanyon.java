...
import rtg.world.biome.realistic.enhancedbiomes.RealisticBiomeEBStoneCanyon;
...
public class SurfaceEBStoneCanyon extends SurfaceEBBase
{
	...
	public SurfaceEBStoneCanyon(Block top, Block fill, byte b, int grassHeight)
	{
		super(top, fill);
		blockByte = b;
		...
		for(int k = 255; k > -1; k--)
		{
            ...
            else if(b == Blocks.stone)
            {
                ...
                if (shouldReplaceStone()) {
                    blocks[(y * 16 + x) * 256 + k] = RealisticBiomeEBStoneCanyon.ebDominantStoneBlock[0];
                    metadata[(y * 16 + x) * 256 + k] = RealisticBiomeEBStoneCanyon.ebDominantStoneMeta[0];
                }
