	...
	public static void addBiomes()
	{
		...
		{			
			...
			if(BiomeManager.alpine.isPresent()) {
				...
				if (ConfigEBXL.generateEBXLBiomes && ebxl_alpine.config._boolean("biomeEnabled")) {
			...
			if(BiomeManager.autumnwoods.isPresent() && ConfigEBXL.generateEBXLAutumnWoods) {
                ...
                if (ConfigEBXL.generateEBXLBiomes && ebxl_autumnwoods.config._boolean("biomeEnabled")) {
			...
			if(BiomeManager.birchforest.isPresent() && ConfigEBXL.generateEBXLBirchForest) {
                ...
                if (ConfigEBXL.generateEBXLBiomes && ebxl_birchforest.config._boolean("biomeEnabled")) {
			...
			if(BiomeManager.extremejungle.isPresent() && ConfigEBXL.generateEBXLExtremeJungle) {
                ...
                if (ConfigEBXL.generateEBXLBiomes && ebxl_extremejungle.config._boolean("biomeEnabled")) {
			...
			if(BiomeManager.forestedhills.isPresent() && ConfigEBXL.generateEBXLForestedHills) {
                ...
                if (ConfigEBXL.generateEBXLBiomes && ebxl_forestedhills.config._boolean("biomeEnabled")) {
			...
			if(BiomeManager.forestedisland.isPresent() && ConfigEBXL.generateEBXLForestedIsland) {
                ...
                if (ConfigEBXL.generateEBXLBiomes && ebxl_forestedisland.config._boolean("biomeEnabled")) {
			...
			if(BiomeManager.glacier.isPresent() && ConfigEBXL.generateEBXLGlacier) {
                ...
                if (ConfigEBXL.generateEBXLBiomes && ebxl_glacier.config._boolean("biomeEnabled")) {
			...
			if(BiomeManager.greenhills.isPresent() && ConfigEBXL.generateEBXLGreenHills) {
                ...
                if (ConfigEBXL.generateEBXLBiomes && ebxl_greenhills.config._boolean("biomeEnabled")) {
			...
			if(BiomeManager.greenswamp.isPresent() && ConfigEBXL.generateEBXLGreenSwamp) {
                ...
                if (ConfigEBXL.generateEBXLBiomes && ebxl_greenswamp.config._boolean("biomeEnabled")) {
			...
			if(BiomeManager.icewasteland.isPresent() && ConfigEBXL.generateEBXLIceWasteland) {
                ...
                if (ConfigEBXL.generateEBXLBiomes && ebxl_icewasteland.config._boolean("biomeEnabled")) {
			...
			if(BiomeManager.marsh.isPresent() && ConfigEBXL.generateEBXLMarsh) {
                ...
                if (ConfigEBXL.generateEBXLBiomes && ebxl_marsh.config._boolean("biomeEnabled")) {
			...
			if(BiomeManager.meadow.isPresent() && ConfigEBXL.generateEBXLMeadow) {
                ...
                if (ConfigEBXL.generateEBXLBiomes && ebxl_meadow.config._boolean("biomeEnabled")) {
			...
			if(BiomeManager.minijungle.isPresent() && ConfigEBXL.generateEBXLMiniJungle) {
                ...
                if (ConfigEBXL.generateEBXLBiomes && ebxl_minijungle.config._boolean("biomeEnabled")) {
			...
			if(BiomeManager.mountaindesert.isPresent() && ConfigEBXL.generateEBXLMountainDesert) {
                ...
                if (ConfigEBXL.generateEBXLBiomes && ebxl_mountaindesert.config._boolean("biomeEnabled")) {
			...
			if(BiomeManager.mountainridge.isPresent() && ConfigEBXL.generateEBXLMountainRidge) {
                ...
                if (ConfigEBXL.generateEBXLBiomes && ebxl_mountainridge.config._boolean("biomeEnabled")) {
			...
			if(BiomeManager.mountaintaiga.isPresent() && ConfigEBXL.generateEBXLMountainTaiga) {
                ...
                if (ConfigEBXL.generateEBXLBiomes && ebxl_mountaintaiga.config._boolean("biomeEnabled")) {
			...
			if(BiomeManager.pineforest.isPresent() && ConfigEBXL.generateEBXLPineForest) {
                ...
                if (ConfigEBXL.generateEBXLBiomes && ebxl_pineforest.config._boolean("biomeEnabled")) {
			...
			if(BiomeManager.rainforest.isPresent() && ConfigEBXL.generateEBXLRainforest) {
                ...
                if (ConfigEBXL.generateEBXLBiomes && ebxl_rainforest.config._boolean("biomeEnabled")) {
			...
			if(BiomeManager.redwoodforest.isPresent() && ConfigEBXL.generateEBXLRedwoodForest) {
                ...
                if (ConfigEBXL.generateEBXLBiomes && ebxl_redwoodforest.config._boolean("biomeEnabled")) {
			...
			if(BiomeManager.redwoodlush.isPresent() && ConfigEBXL.generateEBXLRedwoodLush) {
                ...
                if (ConfigEBXL.generateEBXLBiomes && ebxl_redwoodlush.config._boolean("biomeEnabled")) {
			...
			if(BiomeManager.savanna.isPresent() && ConfigEBXL.generateEBXLSavanna) {
                ...
                if (ConfigEBXL.generateEBXLBiomes && ebxl_savanna.config._boolean("biomeEnabled")) {
			...
			if(BiomeManager.shrubland.isPresent() && ConfigEBXL.generateEBXLShrubland) {
                ...
                if (ConfigEBXL.generateEBXLBiomes && ebxl_shrubland.config._boolean("biomeEnabled")) {
			...
			if(BiomeManager.snowforest.isPresent() && ConfigEBXL.generateEBXLSnowForest) {
                ...
                if (ConfigEBXL.generateEBXLBiomes && ebxl_snowforest.config._boolean("biomeEnabled")) {
			...
			if(BiomeManager.snowyrainforest.isPresent() && ConfigEBXL.generateEBXLSnowyRainforest) {
                ...
                if (ConfigEBXL.generateEBXLBiomes && ebxl_snowyrainforest.config._boolean("biomeEnabled")) {
			...
			if(BiomeManager.temperaterainforest.isPresent() && ConfigEBXL.generateEBXLTemperateRainforest) {
                ...
                if (ConfigEBXL.generateEBXLBiomes && ebxl_temperaterainforest.config._boolean("biomeEnabled")) {
			...
			if(BiomeManager.tundra.isPresent() && ConfigEBXL.generateEBXLTundra) {
                ...
                if (ConfigEBXL.generateEBXLBiomes && ebxl_tundra.config._boolean("biomeEnabled")) {
			...
			if(BiomeManager.wasteland.isPresent() && ConfigEBXL.generateEBXLWasteland) {
                ...
                if (ConfigEBXL.generateEBXLBiomes && ebxl_wasteland.config._boolean("biomeEnabled")) {
			...
			if(BiomeManager.woodlands.isPresent() && ConfigEBXL.generateEBXLWoodlands) {
                ...
                if (ConfigEBXL.generateEBXLBiomes && ebxl_woodlands.config._boolean("biomeEnabled")) {
