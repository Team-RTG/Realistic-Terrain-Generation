...
import rtg.api.biome.highlands.config.BiomeConfigHLAdirondacks;
import rtg.util.CellNoise;
import rtg.util.CliffCalculator;
import rtg.util.OpenSimplexNoise;

public class SurfaceHLAdirondacks extends SurfaceHLBase {
    ...
    public SurfaceHLAdirondacks(BiomeConfig config, IBlockState top, IBlockState filler, IBlockState mixTop, IBlockState mixFill, float mixWidth,
        ...
        mixBlockTop = this.getConfigBlock(config, BiomeConfigHLAdirondacks.surfaceMixBlockId, BiomeConfigHLAdirondacks.surfaceMixBlockMetaId,
            mixTop);
        mixBlockFill = this.getConfigBlock(config, BiomeConfigHLAdirondacks.surfaceMixFillerBlockId,
            BiomeConfigHLAdirondacks.surfaceMixFillerBlockMetaId,
            mixFill);
