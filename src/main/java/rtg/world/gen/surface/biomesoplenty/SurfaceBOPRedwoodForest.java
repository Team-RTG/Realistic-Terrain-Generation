...
public class SurfaceBOPRedwoodForest extends SurfaceBase {
    ...
    public SurfaceBOPRedwoodForest(RealisticBiomeBase biome, boolean genBeach, float minCliff, float stoneCliff, float stoneHeight, float stoneStrength, float clayCliff) {
    ...
    public SurfaceBOPRedwoodForest(RealisticBiomeBase biome, boolean genBeach, float minCliff) {
        super(biome);
        beach = genBeach;
