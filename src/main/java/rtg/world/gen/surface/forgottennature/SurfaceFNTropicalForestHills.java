...
public class SurfaceFNTropicalForestHills extends SurfaceBase {
    ...
    public SurfaceFNTropicalForestHills(BiomeConfig config, IBlockState top, IBlockState fill, boolean genBeach, IBlockState genBeachBlock, float minCliff, float stoneCliff,
