...
public class SurfaceVanillaRedwoodTaigaHills extends SurfaceBase {
    ...
    public SurfaceVanillaRedwoodTaigaHills(RealisticBiomeBase biome, boolean genBeach, float minCliff, float stoneCliff,
    ...
    public SurfaceVanillaRedwoodTaigaHills(RealisticBiomeBase biome, boolean genBeach, float minCliff) {
