...
public class SurfaceBOPCherryBlossomGrove extends SurfaceBase
{
	...
	public SurfaceBOPCherryBlossomGrove(Block top, Block fill, boolean genBeach, Block genBeachBlock, float minCliff) 
	{
		super(top, fill);
		beach = genBeach;
	...
	public SurfaceBOPCherryBlossomGrove(Block top, Block fill, boolean genBeach, Block genBeachBlock, float minCliff, float stoneCliff, float stoneHeight, float stoneStrength, float clayCliff)
	{
