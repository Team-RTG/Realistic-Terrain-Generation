...
public class RealisticBiomeATGTropicalShrubland extends RealisticBiomeATGBase {
    ...
    public RealisticBiomeATGTropicalShrubland(Biome biome) {
    ...
    public TerrainBase initTerrain() {
        ...
        return new TerrainATGTropicalShrubland();
    }
    ...
    public SurfaceBase initSurface() {
        ...
        return new SurfaceATGTropicalShrubland(config, this.baseBiome.topBlock, this.baseBiome.fillerBlock);
    }

    public class SurfaceATGTropicalShrubland extends SurfaceBase {

        public SurfaceATGTropicalShrubland(BiomeConfig config, IBlockState top, IBlockState filler) {
