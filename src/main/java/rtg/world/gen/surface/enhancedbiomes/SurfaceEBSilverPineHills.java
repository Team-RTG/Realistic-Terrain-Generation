...
import rtg.world.biome.realistic.enhancedbiomes.RealisticBiomeEBSilverPineHills;
...
public class SurfaceEBSilverPineHills extends SurfaceEBBase
{
	...
	public SurfaceEBSilverPineHills(Block top, Block fill, boolean genBeach, Block genBeachBlock, float minCliff) 
	{
		super(top, fill);
		beach = genBeach;
	...
	public SurfaceEBSilverPineHills(Block top, Block fill, boolean genBeach, Block genBeachBlock, float minCliff, float stoneCliff, float stoneHeight, float stoneStrength, float snowCliff, float snowHeight, float snowStrength, float clayCliff)
	{
		...
		for(int k = 255; k > -1; k--)
		{
            ...
            else if(b == Blocks.stone)
            {
                ...
                if (shouldReplaceStone()) {
                    blocks[(y * 16 + x) * 256 + k] = RealisticBiomeEBSilverPineHills.ebDominantStoneBlock[0];
                    metadata[(y * 16 + x) * 256 + k] = RealisticBiomeEBSilverPineHills.ebDominantStoneMeta[0];
                }
