...
public class SurfaceVanillaTaigaHills extends SurfaceBase {
    ...
    public SurfaceVanillaTaigaHills(BiomeConfig config, IBlockState top, IBlockState fill, float minCliff) {

        super(config, top, fill);
        min = minCliff;
    }

    public SurfaceVanillaTaigaHills(BiomeConfig config, IBlockState top, IBlockState fill, float minCliff, float stoneCliff,
