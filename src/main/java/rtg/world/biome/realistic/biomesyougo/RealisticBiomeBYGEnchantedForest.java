...
public class RealisticBiomeBYGEnchantedForest extends RealisticBiomeBYGBase {

    public RealisticBiomeBYGEnchantedForest(Biome biome) {
    ...
    public void initDecos() {
        fallenTrees(new IBlockState[]{
                        BlockUtil.getBlockStateFromCfgString("byg:enchantedlog", BlockUtil.getStateLog(BlockPlanks.EnumType.ACACIA)),
                        BlockUtil.getBlockStateFromCfgString("byg:enchantedlog", BlockUtil.getStateLog(BlockPlanks.EnumType.ACACIA))
                },
                new int[]{4, 4}
        );
