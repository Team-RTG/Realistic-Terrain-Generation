...
public class TerrainVanillaMegaTaigaHills extends TerrainBase
{
	...
	public TerrainVanillaMegaTaigaHills(float mountainWidth, float mountainStrength, float depthLake)
	{
		this(mountainWidth, mountainStrength, depthLake, 260f, 68f);
	}
	
	public TerrainVanillaMegaTaigaHills(float mountainWidth, float mountainStrength, float depthLake, float widthLake, float height)
	{
		width = mountainWidth;
