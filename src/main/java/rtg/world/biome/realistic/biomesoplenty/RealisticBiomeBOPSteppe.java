...
public class RealisticBiomeBOPSteppe extends RealisticBiomeBOPBase {
    ...
    public static Biome biome = BOPBiomes.steppe.orNull();
    ...
    public class TerrainBOPSteppe extends TerrainBase {
        ...
        public float generateNoise(IRTGWorld rtgWorld, int x, int y, float border, float river) {
            ...
            return terrainRollingHills(x, y, rtgWorld.simplex(), river, hillStrength, maxHeight, groundNoiseAmplitudeHills, 4f);
        }
    }
    ...
    public SurfaceBase initSurface() {
        ...
        return new SurfaceBOPSteppe(config, biome.topBlock, biome.fillerBlock);
    }
