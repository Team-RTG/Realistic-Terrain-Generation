...
public class RealisticBiomeBOPSeasonalForest extends RealisticBiomeBOPBase {
    ...
    public RealisticBiomeBOPSeasonalForest(BiomeConfig config) {
        ...
        decoFallenTree.randomLogBlocks = new IBlockState[]{Blocks.LOG2.getDefaultState().withProperty(BlockNewLog.VARIANT, BlockPlanks.EnumType.DARK_OAK), Blocks.LOG.getDefaultState(), Blocks.LOG.getDefaultState().withProperty(BlockNewLog.VARIANT, BlockPlanks.EnumType.BIRCH)};
