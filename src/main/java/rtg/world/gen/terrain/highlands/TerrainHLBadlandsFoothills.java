...
public class TerrainHLBadlandsFoothills extends TerrainBase
{
    ...
    public TerrainHLBadlandsFoothills(float hillHeight, float hillWidth, float varHeight, float varWidth, float baseHeight)
    {
        hHeight = hillHeight;
        hWidth = hillWidth;
