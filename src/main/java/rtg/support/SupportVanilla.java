		...
		if (ConfigRTG.generateVanillaBiomes)
		{
			...
			*/
			...
			if (ConfigRTG.generateVanillaStoneBeach)
			{
				Support.addBiome(
						new RealisticBiomeSupport(
							BiomeGenBase.stoneBeach, RTGBiomes.baseRiverWet,
							new TerrainMountainRiver(),
							new SurfaceDesertOasis(Blocks.gravel, Blocks.stone, Blocks.dirt, Blocks.gravel, (byte)0, 1)
						),
						BiomeCategory.COLD
					);
			}
			...
			*/
			...
			if (ConfigRTG.generateVanillaDesertHills)
			{
				Support.addBiome(
						new RealisticBiomeSupport(
							BiomeGenBase.desertHills, RTGBiomes.baseRiverOasis,
			...
			*/
			...
			if (ConfigRTG.generateVanillaForest)
			{
				Support.addBiome(
						new RealisticBiomeSupport(
							BiomeGenBase.forest, RTGBiomes.baseRiverTemperate,
			...
			*/
			...
			if (ConfigRTG.generateVanillaIcePlains)
			{
				Support.addBiome(
						new RealisticBiomeSupport(
							BiomeGenBase.icePlains, RTGBiomes.baseRiverIce,
							new TerrainGrasslandFlats(),
							new SurfaceGrassland(Blocks.snow, Blocks.dirt, Blocks.stone, Blocks.cobblestone)
						),
						BiomeCategory.SNOW
					);
			}
			...
			*/
			...
			if (ConfigRTG.generateVanillaJungleHills)
			{
				Support.addBiome(
						new RealisticBiomeSupport(
							BiomeGenBase.jungleHills, RTGBiomes.baseRiverWet,
							new TerrainMountain(),
							new SurfaceGrassland(Blocks.grass, Blocks.dirt, Blocks.stone, Blocks.cobblestone)
						),
						BiomeCategory.WET
			...
			if (ConfigRTG.generateVanillaJungleEdge)
			{
				Support.addBiome(
						new RealisticBiomeSupport(
							BiomeGenBase.jungleEdge, RTGBiomes.baseRiverWet,
							new TerrainMountain(),
							new SurfaceMountainStone(Blocks.grass, Blocks.dirt, false, null, 1.3f)
						),
						BiomeCategory.WET
					);
			}
			...
			*/
			...
			if (ConfigRTG.generateVanillaMesaPlateau)
			{
				Support.addBiome(
						new RealisticBiomeSupport(
							BiomeGenBase.mesaPlateau, RTGBiomes.baseRiverOasis,
							new TerrainCanyon(true, 35f, 160f, 60f, 40f, 69f),
							new SurfaceCanyon(Blocks.sand, Blocks.sand, (byte)1, 0)
						),
						BiomeCategory.HOT
					);
			}
			...
			if (ConfigRTG.generateVanillaMesaPlateau_F)
			{
				Support.addBiome(
						new RealisticBiomeSupport(
							BiomeGenBase.mesaPlateau_F, RTGBiomes.baseRiverOasis,
							new TerrainCanyon(true, 35f, 160f, 60f, 40f, 69f),
							new SurfaceCanyon(Blocks.sand, Blocks.sand, (byte)1, 0)
						),
						BiomeCategory.HOT
			...
			*/
			...
			if (ConfigRTG.generateVanillaMushroomIsland)
			{
				Support.addBiome(
						new RealisticBiomeSupport(
							BiomeGenBase.mushroomIsland, RTGBiomes.baseRiverWet,
			...
			*/
			...
			if (ConfigRTG.generateVanillaFrozenRiver)
			{
				Support.addBiome(
						new RealisticBiomeSupport(
							BiomeGenBase.frozenRiver, RTGBiomes.baseRiverIce,
							new TerrainFlatLakes(),
							new SurfaceDesertOasis(Blocks.snow, Blocks.snow, Blocks.snow, Blocks.snow, (byte)0, 0)
						),
						BiomeCategory.SNOW
					);
			}
			...
			*/
			...
			if (ConfigRTG.generateVanillaSavannaPlateau)
			{
				Support.addBiome(
						new RealisticBiomeSupport(
							BiomeGenBase.savannaPlateau, RTGBiomes.baseRiverHot,
							new TerrainDuneValley(300f),
							new SurfaceDuneValley(Blocks.grass, Blocks.dirt, 300f, true, true)
						),
						BiomeCategory.HOT
					);
			}
			...
			*/
			...
			if (ConfigRTG.generateVanillaTaiga)
			{
				Support.addBiome(
						new RealisticBiomeSupport(
							BiomeGenBase.taiga, RTGBiomes.baseRiverCold,
							new TerrainFlatLakes(),
			...
			if (ConfigRTG.generateVanillaTaigaHills)
			{
				Support.addBiome(
						new RealisticBiomeSupport(
							BiomeGenBase.taigaHills, RTGBiomes.baseRiverCold,
							new TerrainMountainRiver(),
			...
			if (ConfigRTG.generateVanillaColdTaigaHills)
			{
				Support.addBiome(
						new RealisticBiomeSupport(
							BiomeGenBase.coldTaigaHills, RTGBiomes.baseRiverCold,
							new TerrainMountain(),
							new SurfaceTundra(Blocks.grass, Blocks.dirt)
						),
						BiomeCategory.SNOW
