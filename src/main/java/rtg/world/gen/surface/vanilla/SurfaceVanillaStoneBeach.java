...
public class SurfaceVanillaStoneBeach extends SurfaceBase {
    ...
    public SurfaceVanillaStoneBeach(BiomeConfig config, IBlockState top, IBlockState fill, boolean genBeach, IBlockState genBeachBlock, float minCliff) {
    ...
    public SurfaceVanillaStoneBeach(BiomeConfig config, IBlockState top, IBlockState fill, boolean genBeach, IBlockState genBeachBlock, float minCliff, float stoneCliff, float stoneHeight, float stoneStrength, float clayCliff) {
