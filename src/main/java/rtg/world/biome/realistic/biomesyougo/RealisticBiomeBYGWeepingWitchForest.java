...
public class RealisticBiomeBYGWeepingWitchForest extends RealisticBiomeBYGBase {

    public RealisticBiomeBYGWeepingWitchForest(Biome biome) {
    ...
    public void initDecos() {
        fallenTrees(new IBlockState[]{
                        BlockUtil.getBlockStateFromCfgString("byg:witchhazellog", BlockUtil.getStateLog(BlockPlanks.EnumType.ACACIA)),
                        BlockUtil.getBlockStateFromCfgString("byg:witchhazellog", BlockUtil.getStateLog(BlockPlanks.EnumType.ACACIA))
                },
                new int[]{4, 4}
        );
