...
public class SurfaceGrasslandMixBig extends SurfaceBase {
    ...
    public SurfaceGrasslandMixBig(RealisticBiomeBase biome, IBlockState mixTop, IBlockState mixFill, IBlockState cliff1, IBlockState cliff2, float mixWidth, float mixHeight, float smallWidth, float smallStrength) {
        super(biome);
