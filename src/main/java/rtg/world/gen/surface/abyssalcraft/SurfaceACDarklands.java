...
import rtg.api.config.vanilla.config.BiomeConfigVanillaForestHills;
...
public class SurfaceACDarklands extends SurfaceBase {
    ...
    public SurfaceACDarklands(BiomeConfig config, IBlockState top, IBlockState fill, boolean genBeach, IBlockState genBeachBlock, float minCliff, float stoneCliff,
