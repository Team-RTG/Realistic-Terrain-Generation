...
import rtg.api.biome.biomesyougo.config.BiomeConfigBYGFrozenTundra;
...
public class RealisticBiomeBYGFrozenTundra extends RealisticBiomeBYGBase {
    ...
    public RealisticBiomeBYGFrozenTundra(Biome biome, BiomeConfig config) {
        ...
        super(config, biome, river,
            ...
            new SurfaceBYGFrozenTundra(config,
        ...
        this.addDeco(decoFallenTree, this.config._boolean(BiomeConfigBYGFrozenTundra.decorationLogsId));
