...
public class TerrainEBBlossomHills extends TerrainBase
{
	...
	public TerrainEBBlossomHills(float mountainWidth, float mountainStrength, float depthLake)
	{
		this(mountainWidth, mountainStrength, depthLake, 260f, 68f);
	}
	
	public TerrainEBBlossomHills(float mountainWidth, float mountainStrength, float depthLake, float widthLake, float height)
	{
		width = mountainWidth;
