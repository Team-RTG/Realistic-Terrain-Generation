...
public class RealisticBiomeBOPMapleWoods extends RealisticBiomeBOPBase {
    ...
    public RealisticBiomeBOPMapleWoods(BiomeConfig config) {
        ...
        decoFallenTree.randomLogBlocks = new IBlockState[]{Blocks.LOG.getDefaultState(), Blocks.LOG.getDefaultState().withProperty(BlockNewLog.VARIANT, BlockPlanks.EnumType.SPRUCE)};
