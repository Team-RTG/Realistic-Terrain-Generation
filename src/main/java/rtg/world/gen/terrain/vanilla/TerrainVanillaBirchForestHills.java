...
public class TerrainVanillaBirchForestHills extends TerrainBase
{
	 ...
	 */
	public TerrainVanillaBirchForestHills(float hillHeight, float hillWidth, float varHeight, float varWidth, float lakeHeight, float lakeWidth, float baseHeight)
	{
		hHeight = hillHeight;
		hWidth = hillWidth;
