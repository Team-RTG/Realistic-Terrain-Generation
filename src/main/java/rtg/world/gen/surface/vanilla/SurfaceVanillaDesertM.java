        ...
        for (int k = 255; k > -1; k--) {
            ...
            if (b == Blocks.air) {
                ...
                if (depth == 0) {
                    ...
                    if (cliff == 1) {
                        primer.setBlockState(x, 256 + k, y, rand.nextInt(3) == 0 ? Blocks.sandstone.getDefaultState() : Blocks.sand.getDefaultState());
                    } else if (cliff == 2) {
                        primer.setBlockState(x, 256 + k, y, getShadowDesertBlock(world, i, j, x, y, k));
                    } else if (k < 63) {
                        if (beach) {
