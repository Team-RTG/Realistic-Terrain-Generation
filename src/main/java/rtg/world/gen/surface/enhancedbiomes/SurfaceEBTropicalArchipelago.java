...
import rtg.world.biome.realistic.enhancedbiomes.RealisticBiomeEBTropicalArchipelago;
...
public class SurfaceEBTropicalArchipelago extends SurfaceEBBase
{
	...
	public SurfaceEBTropicalArchipelago(Block top, Block fill, boolean genBeach, Block genBeachBlock, float minCliff) 
	{
		super(top, fill);
		beach = genBeach;
	...
	public SurfaceEBTropicalArchipelago(Block top, Block fill, boolean genBeach, Block genBeachBlock, float minCliff, float stoneCliff, float stoneHeight, float stoneStrength, float snowCliff, float snowHeight, float snowStrength, float clayCliff)
	{
		...
		for(int k = 255; k > -1; k--)
		{
            ...
            else if(b == Blocks.stone)
            {
                ...
                if (shouldReplaceStone()) {
                    blocks[(y * 16 + x) * 256 + k] = RealisticBiomeEBTropicalArchipelago.ebDominantStoneBlock[0];
                    metadata[(y * 16 + x) * 256 + k] = RealisticBiomeEBTropicalArchipelago.ebDominantStoneMeta[0];
                }
