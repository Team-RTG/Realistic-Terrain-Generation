...
public class TerrainEBXLBirchForest extends TerrainBase
{
	...
	public TerrainEBXLBirchForest(float mountainWidth, float mountainStrength, float depthLake)
	{
		this(mountainWidth, mountainStrength, depthLake, 260f, 68f);
	}
	
	public TerrainEBXLBirchForest(float mountainWidth, float mountainStrength, float depthLake, float widthLake, float height)
	{
		width = mountainWidth;
