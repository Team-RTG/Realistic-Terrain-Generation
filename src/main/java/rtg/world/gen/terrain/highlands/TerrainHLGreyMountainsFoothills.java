...
public class TerrainHLGreyMountainsFoothills extends TerrainBase
{
    private float width;
    ...
    public TerrainHLGreyMountainsFoothills(float mountainWidth, float mountainStrength, float height)
    {
        width = mountainWidth;
