...
public class RTGBiomeVanillaRedwoodTaigaHills extends RTGBiomeVanilla {
    ...
    public RTGBiomeVanillaRedwoodTaigaHills() {

        super(Biomes.MUTATED_REDWOOD_TAIGA_HILLS, Biomes.RIVER);
    ...
    public TerrainBase initTerrain() {
        ...
        return new TerrainBase() {
            ...
            public float generateNoise(RTGWorld rtgWorld, int x, int y, float biomeWeight, float border, float river) {
                ...
                return terrainMountainRiver(x, y, rtgWorld.simplex, rtgWorld.cell, river, 300f, 68f);
            }
        };
    }
