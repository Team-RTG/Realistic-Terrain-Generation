...
public class SurfaceBOPSnowyConiferousForest extends SurfaceBase {
    ...
    public SurfaceBOPSnowyConiferousForest(RealisticBiomeBase biome, boolean genBeach, IBlockState genBeachBlock, float minCliff, float stoneCliff, float stoneHeight, float stoneStrength, float snowCliff, float snowHeight, float snowStrength, float clayCliff) {
    ...
    public SurfaceBOPSnowyConiferousForest(RealisticBiomeBase biome, boolean genBeach, IBlockState genBeachBlock, float minCliff) {
        super(biome);
        beach = genBeach;
