...
public class SurfaceVanillaMushroomIsland extends SurfaceBase {
    ...
    public SurfaceVanillaMushroomIsland(RealisticBiomeBase biome, int beachHeight, float minCliff, float stoneCliff, float stoneHeight, float stoneStrength, float clayCliff) {
    ...
    public SurfaceVanillaMushroomIsland(RealisticBiomeBase biome, int beachHeight, float minCliff) {
        super(biome);
        beach = beachHeight;
