...
public class RealisticBiomeBYGZelkovaForest extends RealisticBiomeBYGBase {

    public RealisticBiomeBYGZelkovaForest(Biome biome) {
    ...
    public void initDecos() {
        fallenTrees(new IBlockState[]{
                        BlockUtil.getBlockStateFromCfgString("byg:zelkovalog", BlockUtil.getStateLog(BlockPlanks.EnumType.OAK)),
                        BlockUtil.getBlockStateFromCfgString("byg:zelkovalog", BlockUtil.getStateLog(BlockPlanks.EnumType.OAK))
                },
                new int[]{4, 4}
        );
