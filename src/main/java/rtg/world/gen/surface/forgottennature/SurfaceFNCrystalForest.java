...
public class SurfaceFNCrystalForest extends SurfaceBase {
    ...
    public SurfaceFNCrystalForest(BiomeConfig config, IBlockState top, IBlockState fill, boolean genBeach, IBlockState genBeachBlock, float minCliff, float stoneCliff,
