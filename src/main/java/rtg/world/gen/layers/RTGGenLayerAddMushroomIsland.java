...
public class RTGGenLayerAddMushroomIsland extends GenLayerRTG
{
    private static final String __OBFID = "CL_00000552";

    public RTGGenLayerAddMushroomIsland(long p_i2120_1_, GenLayer p_i2120_3_)
    {
        super(p_i2120_1_);
    ...
    public int[] getInts(int p_75904_1_, int p_75904_2_, int p_75904_3_, int p_75904_4_)
    {
        ...
        for (int i2 = 0; i2 < p_75904_4_; ++i2)
        {
            for (int j2 = 0; j2 < p_75904_3_; ++j2)
            {
                ...
                {
                    aint1[j2 + i2 * p_75904_3_] = RealisticBiomeBase.vanillaMushroomIsland.biomeID;
                }
                else
                {
