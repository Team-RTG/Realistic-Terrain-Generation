...
public class RealisticBiomeZOEGrassyFen extends RealisticBiomeZOEBase {

    public RealisticBiomeZOEGrassyFen(Biome biome) {
        super(biome);
    }
    ...
    protected IBlockState getMixBlock1() {
        return BlockUtil.getBlockStateFromCfgString("valoegheses_be:soil_wet", BlockUtil.getStateDirt(BlockDirt.DirtType.PODZOL));
    }
    ...
    public SurfaceBase initSurface() {
        ...
        return new SurfaceVanillaForest(getConfig(), baseBiome().topBlock, baseBiome().fillerBlock,
                ...
                getMixBlock1(), 0.7f, getMixBlock2(), -0.5f);
    }
