...
public class RealisticBiomeAddonJungleCanyon extends RealisticBiomeBase
{
	private TerrainBase terrain;
	private SurfaceBase surface;
	
	public RealisticBiomeAddonJungleCanyon() 
	{
		super(
		...
		this.setRealisticBiomeName("Jungle Canyon");
		this.biomeSize = BiomeSize.NORMAL;
		this.biomeWeight = ConfigAddon.weightJungleCanyon;
	}
