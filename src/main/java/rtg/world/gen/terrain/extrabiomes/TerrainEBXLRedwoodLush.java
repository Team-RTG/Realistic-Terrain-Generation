...
public class TerrainEBXLRedwoodLush extends TerrainBase
{
	...
	public TerrainEBXLRedwoodLush(float mountainWidth, float mountainStrength, float depthLake)
	{
		this(mountainWidth, mountainStrength, depthLake, 260f, 68f);
	}
	
	public TerrainEBXLRedwoodLush(float mountainWidth, float mountainStrength, float depthLake, float widthLake, float height)
	{
		width = mountainWidth;
