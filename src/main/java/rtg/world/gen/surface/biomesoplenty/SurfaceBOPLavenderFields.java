...
public class SurfaceBOPLavenderFields extends SurfaceBase {
    ...
    public SurfaceBOPLavenderFields(RealisticBiomeBase biome, boolean genBeach, IBlockState genBeachBlock, float minCliff, float stoneCliff,
                                    float stoneHeight, float stoneStrength, float clayCliff, IBlockState biome.config.MIX_BLOCK.get(), float mixSize) {
