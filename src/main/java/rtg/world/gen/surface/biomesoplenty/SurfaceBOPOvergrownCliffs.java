...
public class SurfaceBOPOvergrownCliffs extends SurfaceBase
{
	...
	public SurfaceBOPOvergrownCliffs(BiomeConfig config, Block top, Block fill, boolean genBeach, Block genBeachBlock, float minCliff) 
	{
	...
	public SurfaceBOPOvergrownCliffs(BiomeConfig config, Block top, Block fill, boolean genBeach, Block genBeachBlock, float minCliff, float stoneCliff, float stoneHeight, float stoneStrength, float clayCliff)
	{
