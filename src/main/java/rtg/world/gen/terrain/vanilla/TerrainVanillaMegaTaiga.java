...
public class TerrainVanillaMegaTaiga extends TerrainBase
{
	...
	public TerrainVanillaMegaTaiga(float mountainWidth, float mountainStrength, float depthLake)
	{
		this(mountainWidth, mountainStrength, depthLake, 260f, 68f);
	}
	
	public TerrainVanillaMegaTaiga(float mountainWidth, float mountainStrength, float depthLake, float widthLake, float height)
	{
		width = mountainWidth;
