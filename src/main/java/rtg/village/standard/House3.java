...
public class House3 extends StructureVillagePiecesRTG.Village
{
	public House3() {
	}

	public House3(StructureVillagePiecesRTG.Start p_i2106_1_, int p_i2106_2_, Random p_i2106_3_, StructureBoundingBox p_i2106_4_, int p_i2106_5_) {
		super(p_i2106_1_, p_i2106_2_);
		this.coordBaseMode = p_i2106_5_;
		this.boundingBox = p_i2106_4_;
	}

	public static House3 getPiece(StructureVillagePiecesRTG.Start p_74921_0_, List p_74921_1_, Random p_74921_2_, int p_74921_3_, int p_74921_4_, int p_74921_5_, int p_74921_6_, int p_74921_7_) {
