...
public class GenLayerBiomeRTG extends GenLayerBiome
{
	...
	public GenLayerBiomeRTG(long seed, GenLayer parentLayer, WorldType worldType) 
	{
		super(seed, parentLayer, worldType);
		
		this.biomeLists[0].add((BiomeEntry) BiomeManagerRTG.overworldBiomes[0]);
		this.biomeLists[1].add((BiomeEntry) BiomeManagerRTG.overworldBiomes[1]);
		this.biomeLists[2].add((BiomeEntry) BiomeManagerRTG.overworldBiomes[2]);
		this.biomeLists[3].add((BiomeEntry) BiomeManagerRTG.overworldBiomes[3]);
            ...
            //    	outputBiomeIDs[j1 + i1 * width] = BOPBiomes.onlyBiome.biomeID;
              //  	continue;
               // }
                ...
                else if (currentBiomeID == RealisticBiomeVanillaBase.vanillaMushroomIsland.biomeID)
                {
                    outputBiomeIDs[j1 + i1 * width] = currentBiomeID;
                }
                else if (currentBiomeID == 1)
                {
                    if (l1 > 0)
                    {
                        if (this.nextInt(3) == 0 && BiomeGenRTG.mesaPlateauGen)
                        {
                            outputBiomeIDs[j1 + i1 * width] = RealisticBiomeVanillaBase.vanillaMesaPlateau.biomeID;
                        }
                        else if (BiomeGenRTG.mesaPlateauFGen)
                        {
                            outputBiomeIDs[j1 + i1 * width] = RealisticBiomeVanillaBase.vanillaMesaPlateau_F.biomeID;
                        }
                        else
                        {
                ...
                {
                    if (l1 > 0 && BiomeGenRTG.jungleGen)
                    {
                        outputBiomeIDs[j1 + i1 * width] = RealisticBiomeVanillaBase.vanillaJungle.biomeID;
                    }
                    else
                    {
                ...
                {
                    if (l1 > 0 && BiomeGenRTG.megaTaigaGen)
                    {
                        outputBiomeIDs[j1 + i1 * width] = RealisticBiomeVanillaBase.vanillaMegaTaiga.biomeID;
                    }
                    else
                    {
    ...
    {
        return (biomeId == RealisticBiomeVanillaBase.vanillaOcean.biomeID  && BiomeGenRTG.oceanGen)|| (biomeId == RealisticBiomeVanillaBase.vanillaDeepOcean.biomeID && BiomeGenRTG.deepOceanGen); // || (biomeId == RealisticBiomeVanillaBase.vanillaFrozenOcean.biomeID && BiomeGenRTG.frozenOceanGen);
    }
}