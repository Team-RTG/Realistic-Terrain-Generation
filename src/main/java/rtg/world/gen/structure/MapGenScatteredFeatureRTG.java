 ...
 * Modified by: srs-bsns (https://github.com/srs-bsns)
...
public class MapGenScatteredFeatureRTG extends MapGenScatteredFeature {
    ...
    public MapGenScatteredFeatureRTG(Map<? extends String, ? extends String> p_i2061_1_) {

        this();

        for (Entry<? extends String, ? extends String> entry : p_i2061_1_.entrySet()) {
    ...
    public static class Start extends MapGenScatteredFeature.Start {
        ...
        Start(World worldIn, Random random, int chunkX, int chunkZ) {
            ...
            LinkedList<ComponentScatteredFeaturePieces.DesertPyramid> desertTempleComponents = new LinkedList<>();
            LinkedList<ComponentScatteredFeaturePieces.JunglePyramid> jungleTempleComponents = new LinkedList<>();
            LinkedList<ComponentScatteredFeaturePieces.SwampHut> witchHutComponents = new LinkedList<>();
