...
public class BiomeConfig extends Config {
    ...
    public BiomeConfig() {
        ...
        WHEAT_CHANCE = new ConfigPropertyInt("Wheat (Chance)", "Decorations.Wheat", "", 0, 0, Integer.MAX_VALUE);
        WHEAT_MIN_Y = new ConfigPropertyInt("Wheat (Min Y)", "Decorations.Wheat", "", 0, 0, Integer.MAX_VALUE);
        WHEAT_MAX_Y = new ConfigPropertyInt("Wheat (Max Y)", "Decorations.Wheat", "", 0, 0, Integer.MAX_VALUE);
        USE_ARCTIC_SURFACE = new ConfigPropertyBoolean("Use Arctic Surface", "Surfaces.Arctic Surface", "", true);
        ALLOW_ICE_TREES = new ConfigPropertyBoolean("Allow Ice Trees", "Trees.Ice Trees", "", true);
