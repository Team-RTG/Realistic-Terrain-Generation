...
public class SurfaceBOPMountainFoothills extends SurfaceBase
{
    ...
    public SurfaceBOPMountainFoothills(BiomeConfig config, Block top, byte topByte, Block filler, byte fillerByte, Block mixTop, byte mixTopByte, Block mixFiller,
